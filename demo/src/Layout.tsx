...
export function Layout() {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: location is the trigger, closing the mobile drawer on navigation
	useEffect(() => {
		...
		<div className="drawer drawer-mobile lg:drawer-open">
			...
			<div className="drawer-content flex flex-col">
				...
				<div className="navbar bg-base-200 text-base-content w-full">
					<label htmlFor="my-drawer" aria-label="Toggle drawer" className="btn btn-ghost cursor-pointer lg:hidden">
						<svg
							width="20"
							height="20"
					...
					<span className="lg:hidden">
						<Link to="/" className="btn btn-ghost text-neutral font-mono text-lg font-bold">
							@iwsio/forms
						</Link>
				...
				<footer className="flex-0 footer footer-center bg-base-300 text-base-content p-4">
					<div>
						<p>Created by the Integrated Web Systems, LLC &middot; &copy; {now.year}</p>
					</div>
				</footer>
			</div>
